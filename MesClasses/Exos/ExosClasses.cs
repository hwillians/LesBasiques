...
namespace MesClasses.Exos
{
    class ExosClasses
    {
        ...
        {
            Personne personne1 = new Personne(GetString("Tapez le Prenom : "), GetString("Tapez le nom : "), StringToDate("Tapez la date de naissance : "));
        ...
        {
            Personne personne1 = new(GetString("Tapez le Prenom : "), GetString("Tapez le nom : "), StringToDate("Tapez la date de naissance : "));
        ...
        {
            var tabPersonnes = new Personne[4];
            ...
            var tabTravailleurs = new ITravailleur[4];
